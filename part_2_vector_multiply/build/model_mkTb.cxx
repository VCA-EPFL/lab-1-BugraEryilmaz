 ...
 * 
 * On Wed Feb 28 15:33:10 CET 2024
 * 
 */
...
static void schedule_posedge_CLK(tSimStateHdl simHdl, void *instance_ptr)
	 ...
	 tUInt8 DEF_INST_top_INST_mma_DEF_done_a__h3377;
	 tUInt8 DEF_INST_top_INST_mma_DEF_done_b__h3594;
	 tUInt8 DEF_INST_top_INST_mma_DEF_req_a_ready__h3381;
	 tUInt8 DEF_INST_top_INST_mma_DEF_req_b_ready__h3598;
	 ...
	 INST_top.INST_mma.PORT_EN_start = (tUInt8)0u;
	 INST_top.INST_mma.DEF_WILL_FIRE_start = (tUInt8)0u;
	 ...
	 INST_top.INST_mma.DEF_ready_start__h3375 = INST_top.INST_mma.INST_ready_start.METH_read();
	 INST_top.INST_mma.DEF_b__h868 = INST_top.INST_mma.INST_a_serverAdapter_cnt.METH_read();
	 DEF_INST_top_INST_mma_DEF_req_a_ready__h3381 = INST_top.INST_mma.INST_req_a_ready.METH_read();
	 DEF_INST_top_INST_mma_DEF_done_a__h3377 = INST_top.INST_mma.INST_done_a.METH_read();
	 DEF_INST_top_INST_mma_DEF_CAN_FIRE_RL_process_a = primSLT8(1u,
								    3u,
								    (tUInt8)(INST_top.INST_mma.DEF_b__h868),
								    3u,
								    (tUInt8)3u) && ((INST_top.INST_mma.DEF_ready_start__h3375 && !DEF_INST_top_INST_mma_DEF_done_a__h3377) && !DEF_INST_top_INST_mma_DEF_req_a_ready__h3381);
	 DEF_INST_top_INST_mma_DEF_WILL_FIRE_RL_process_a = DEF_INST_top_INST_mma_DEF_CAN_FIRE_RL_process_a;
	 INST_top.INST_mma.DEF_b__h2341 = INST_top.INST_mma.INST_b_serverAdapter_cnt.METH_read();
	 DEF_INST_top_INST_mma_DEF_req_b_ready__h3598 = INST_top.INST_mma.INST_req_b_ready.METH_read();
	 DEF_INST_top_INST_mma_DEF_done_b__h3594 = INST_top.INST_mma.INST_done_b.METH_read();
	 DEF_INST_top_INST_mma_DEF_CAN_FIRE_RL_process_b = primSLT8(1u,
								    3u,
								    (tUInt8)(INST_top.INST_mma.DEF_b__h2341),
								    3u,
								    (tUInt8)3u) && ((INST_top.INST_mma.DEF_ready_start__h3375 && !DEF_INST_top_INST_mma_DEF_done_b__h3594) && !DEF_INST_top_INST_mma_DEF_req_b_ready__h3598);
	 ...
	 INST_top.INST_mma.DEF_WILL_FIRE_start = INST_top.INST_mma.PORT_EN_start;
	 INST_top.INST_mma.DEF_done_all__h3781 = INST_top.INST_mma.INST_done_all.METH_read();
...
time_t MODEL_mkTb::get_creation_time()
{
  ...
  /* Wed Feb 28 14:33:10 UTC 2024 */
  return 1709130790llu;
}
